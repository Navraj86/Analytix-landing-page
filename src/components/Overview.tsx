    ...
    <section className="section">
        <div className="container">
                ...
                <Dialog>
                    ...
                    <DialogContent className="p-0 overflow-hidden max-w-[640px] xl:max-w-[1000px]">
                        <AspectRatio ratio={16/9}>
                            <ReactPlayer src='https://youtu.be/J0shA9J-4Nc?si=3-JJYzOuhxCu9n4z' style={{ minWidth: '100%', maxWidth: '100%', minHeight: '100%', maxHeight: '100%' }} />
                        </AspectRatio>
                    </DialogContent>
                </Dialog>
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 gap-5 mt-8 md:mt-16 xl:grid-cols-[3fr,2.5fr] xl:items-center">
                <motion.p variants={variants.fadeInRight} initial='start' whileInView='end' viewport={{ once: true }} className="section-title text-center lg:max-w-[30ch] lg:mx-auto xl:text-left">{overviewData.listTitle}</motion.p>
